...
function detail_initialize() {
	latitude = $('#latitude').val();
	longitude = $('#longitude').val();
	maptooltiphtml = $('#maptooltiphtml').val();
  ...
  marker = new google.maps.Marker({position: myLatlng, map: map,icon: $('#baseUrl').val()+'/application/layouts/scripts/themes/trailblazer/js/map/clusters/marker-icon.png',title: maptooltiphtml});
}
function loadScript(mapid,latitude,longitude) {
...
//                                        "type": "circle",
//                                        "properties": {
//                                            "description": $('#maptooltiphtml').val()
//                                        },
//                                        "geometry": {
//                                            "type": "Point",
...
//  script.src = "https://maps.googleapis.com/maps/api/js?key=AIzaSyDgEVS1bmgtaauzCtP5ixJl5taVmeuai5I&libraries=places&sensor=false&callback=detail_initialize";
