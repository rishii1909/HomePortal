...
(function($){
	$(document).ready(function (){
		$("#blogList").on( "click", ".pagination a", function (e){
			e.preventDefault();			
		...
		$(".loadmoreBmobile").on( "click", function (e){
			...
			if(page!=''){
				$('.pageLoader').fadeIn(); //show loading element
				$.post('ajaxPaginationBlog', {"page":page,"totalRecords":$('#totalRecords').val(),"Tag":$('#Tag').val(),"blogstagfilter":blogstagfilter,"blogssortby":blogssortby,"bdisplay":bdisplay}, function(data) {
